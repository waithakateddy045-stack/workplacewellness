...
const SITE_CONFIG = {
    ...
    tagline: "Today's Workplace. Your Future.",
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item">
                     ...
                     <div class="dropdown-menu">
                        ...
                        <a href="${ROOT}approaches/business-training.html" class="dropdown-item">Training and MHFA</a>
...
function injectShareButtons() {
    ...
    articles.forEach(article => {
        // Skip if share bar already exists inside this article
        if (article.querySelector('.share-bar')) return;
